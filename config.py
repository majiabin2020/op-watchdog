...
HEALTHCHECK_TIMEOUT = 8      # OpenClaw CLI 健康检查超时（秒）
AUTOSTART_KEY = "LaomaClawWatchdog"
APP_ID = "com.laoma.openclaw.watchdog"
GATEWAY_PROCESS_NAME = "node"              # 进程名（openclaw gateway 以 node 进程运行）
GATEWAY_PROCESS_CMDLINE = "openclaw"       # cmdline 关键词，用于精确定位正确的 node 进程
OPENCLAW_ENTRY_SCRIPT = ("node_modules", "openclaw", "openclaw.mjs")
GATEWAY_START_ARGS = ["gateway"]
GATEWAY_STOP_ARGS = ["gateway", "stop"]
GATEWAY_HEALTH_ARGS = ["health", "--json"]
